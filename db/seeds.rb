...
# User.create(name: '中出　稀平', nick_name: 'きぺ', profile_image: open("#{Rails.root}/db/user-image/my.jpeg"), postal_code: '5940071', prefecture: '大阪府', city: '和泉市府中町', street: '1-1-1', email: 'kipe@kipe', password: '123456')
# User.create(name: '武田　光栄', nick_name: 'kou00', profile_image: open("#{Rails.root}/db/user-image/m1.jpg"), postal_code: '4567890', prefecture: '愛知県', city: '名古屋市熱田区', street: '1-1-1', email: 'take@take', password: '123456')
# User.create(name: '明智小五郎', nick_name: 'あけち', profile_image: open("#{Rails.root}/db/user-image/m2.jpg"), postal_code: '2345678', prefecture: '神奈川県', city: '横浜市港南区', street: '1-1-1', email: 'aketi@aketi', password: '123456')
# User.create(name: '田中　太郎', nick_name: 'tarou01', profile_image: open("#{Rails.root}/db/user-image/back1.jpeg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'taro@taro', password: '123456')
# User.create(name: '山田　花子', nick_name: '花子', profile_image: open("#{Rails.root}/db/user-image/w1.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hana@hana', password: '123456')
# User.create(name: '黒川　宏', nick_name: 'ひろし', profile_image: open("#{Rails.root}/db/user-image/m3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'hirosi@hirosi', password: '123456')
# User.create(name: '渡辺　駿', nick_name: '駿', profile_image: open("#{Rails.root}/db/user-image/back2.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'syun@syun', password: '123456')
# User.create(name: '佐藤　公子', nick_name: 'くみこ', profile_image: open("#{Rails.root}/db/user-image/w2.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kumi@kumi', password: '123456')
# User.create(name: '南　麻子', nick_name: '南', profile_image: open("#{Rails.root}/db/user-image/w3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'minami@minami', password: '123456')
# User.create(name: '小林　友美', nick_name: 'jdhgl10', profile_image: open("#{Rails.root}/db/user-image/w4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tomomi@tomomi', password: '123456')
# User.create(name: '徳元　雛乃', nick_name: 'hinano', profile_image: open("#{Rails.root}/db/user-image/back3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'hinano@hinano', password: '123456')
# User.create(name: '本田　大輝', nick_name: 'だいだい', profile_image: open("#{Rails.root}/db/user-image/back4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'daidai@daidai', password: '123456')
# User.create(name: '磯部　光輝', nick_name: '光輝', profile_image: open("#{Rails.root}/db/user-image/back5.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'kouki@kouki', password: '123456')
# User.create(name: '清水　俊太', nick_name: 'マレー', profile_image: open("#{Rails.root}/db/user-image/back6.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'mare@mare', password: '123456')
# User.create(name: '是枝　ショーン', nick_name: 'ショーン', profile_image: open("#{Rails.root}/db/user-image/m4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'sion@sion', password: '123456')
# User.create(name: '石野　翔太', nick_name: '空手家', profile_image: open("#{Rails.root}/db/user-image/m5.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'syoubu@syoubu', password: '123456')
# User.create(name: '河内山　翔', nick_name: '河内山', profile_image: open("#{Rails.root}/db/user-image/m6.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'syu@syu', password: '123456')
# User.create(name: '池田　莉子', nick_name: '莉子', profile_image: open("#{Rails.root}/db/user-image/w5.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'riko@riko', password: '123456')
# User.create(name: '下地　亜紀', nick_name: 'akiaki', profile_image: open("#{Rails.root}/db/user-image/back7.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'akiaki@akiaki', password: '123456')
# User.create(name: '栗芝　瞳', nick_name: 'hitomi', profile_image: open("#{Rails.root}/db/user-image/back8.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hitomi@hitomi', password: '123456')
# User.create(name: '鈴木　章吾', nick_name: 'kmvkji', profile_image: open("#{Rails.root}/db/user-image/m7.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'syogo@syogo', password: '123456')
# User.create(name: '斎藤　智也', nick_name: '智也', profile_image: open("#{Rails.root}/db/user-image/back9.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tomoya@tomoya', password: '123456')
# User.create(name: '山田　加奈子', nick_name: 'kanako', profile_image: open("#{Rails.root}/db/user-image/back10.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kanako@knk', password: '123456')
# User.create(name: '宮本　香織', nick_name: 'かおり', profile_image: open("#{Rails.root}/db/user-image/back11.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kaori@kor', password: '123456')
# User.create(name: '香川　俊樹', nick_name: 'toshiki', profile_image: open("#{Rails.root}/db/user-image/back12.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tosiki@tsk', password: '123456')
# User.create(name: '松本　仁志', nick_name: 'まっちゃん', profile_image: open("#{Rails.root}/db/user-image/back13.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hitosi@matumoto', password: '123456')
# User.create(name: '浜田　正敏', nick_name: 'はまちゃん', profile_image: open("#{Rails.root}/db/user-image/back14.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'masatosi@hamada', password: '123456')
# User.create(name: '浜家　和成', nick_name: 'kazu', profile_image: open("#{Rails.root}/db/user-image/back15.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kazu@kazu', password: '123456')
