...
# User.create(name: '中出　稀平', nick_name: 'きぺ', profile_image: open("#{Rails.root}/db/user-image/my.jpeg"), postal_code: '5940071', prefecture: '大阪府', city: '和泉市府中町', street: '1-1-1', email: 'kipe@kipe', password: '123456', age: '20代', gender: '男',)
# User.create(name: '武田　光栄', nick_name: 'kou00', profile_image: open("#{Rails.root}/db/user-image/m1.jpg"), postal_code: '4567890', prefecture: '愛知県', city: '名古屋市熱田区', street: '1-1-1', email: 'take@take', password: '123456', age: '20代', gender: '男',)
# User.create(name: '明智小五郎', nick_name: 'あけち', profile_image: open("#{Rails.root}/db/user-image/m2.jpg"), postal_code: '2345678', prefecture: '神奈川県', city: '横浜市港南区', street: '1-1-1', email: 'aketi@aketi', password: '123456', age: '30代', gender: '男',)
# User.create(name: '田中　太郎', nick_name: 'tarou01', profile_image: open("#{Rails.root}/db/user-image/back1.jpeg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'taro@taro', password: '123456', age: '20代', gender: '男',)
# User.create(name: '山田　花子', nick_name: '花子', profile_image: open("#{Rails.root}/db/user-image/w1.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hana@hana', password: '123456', age: '20代', gender: '女',)
# User.create(name: '黒川　宏', nick_name: 'ひろし', profile_image: open("#{Rails.root}/db/user-image/m3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'hirosi@hirosi', password: '123456', age: '30代', gender: '男',)
# User.create(name: '渡辺　駿', nick_name: '駿', profile_image: open("#{Rails.root}/db/user-image/back2.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'syun@syun', password: '123456', age: '30代', gender: '男',)
# User.create(name: '佐藤　公子', nick_name: 'くみこ', profile_image: open("#{Rails.root}/db/user-image/w2.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kumi@kumi', password: '123456', age: '20代', gender: '女',)
# User.create(name: '南　麻子', nick_name: '南', profile_image: open("#{Rails.root}/db/user-image/w3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'minami@minami', password: '123456', age: '20代', gender: '女',)
# User.create(name: '小林　友美', nick_name: 'jdhgl10', profile_image: open("#{Rails.root}/db/user-image/w4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tomomi@tomomi', password: '123456', age: '20代', gender: '女',)
# User.create(name: '徳元　雛乃', nick_name: 'hinano', profile_image: open("#{Rails.root}/db/user-image/back3.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'hinano@hinano', password: '123456', age: '20代', gender: '女',)
# User.create(name: '本田　大輝', nick_name: 'だいだい', profile_image: open("#{Rails.root}/db/user-image/back4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'daidai@daidai', password: '123456', age: '30代', gender: '男',)
# User.create(name: '磯部　光輝', nick_name: '光輝', profile_image: open("#{Rails.root}/db/user-image/back5.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'kouki@kouki', password: '123456', age: '20代', gender: '男',)
# User.create(name: '清水　俊太', nick_name: 'マレー', profile_image: open("#{Rails.root}/db/user-image/back6.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'mare@mare', password: '123456', age: '30代', gender: '男',)
# User.create(name: '是枝　ショーン', nick_name: 'ショーン', profile_image: open("#{Rails.root}/db/user-image/m4.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'sion@sion', password: '123456', age: '20代', gender: '男',)
# User.create(name: '石野　翔太', nick_name: '空手家', profile_image: open("#{Rails.root}/db/user-image/m5.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'syoubu@syoubu', password: '123456', age: '30代', gender: '男',)
# User.create(name: '河内山　翔', nick_name: '河内山', profile_image: open("#{Rails.root}/db/user-image/m6.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'syu@syu', password: '123456', age: '20代', gender: '男',)
# User.create(name: '池田　莉子', nick_name: '莉子', profile_image: open("#{Rails.root}/db/user-image/w5.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'riko@riko', password: '123456', age: '30代', gender: '女',)
# User.create(name: '下地　亜紀', nick_name: 'akiaki', profile_image: open("#{Rails.root}/db/user-image/back7.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'akiaki@akiaki', password: '123456', age: '20代', gender: '女',)
# User.create(name: '栗芝　瞳', nick_name: 'hitomi', profile_image: open("#{Rails.root}/db/user-image/back8.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hitomi@hitomi', password: '123456', age: '30代', gender: '女',)
# User.create(name: '鈴木　章吾', nick_name: 'kmvkji', profile_image: open("#{Rails.root}/db/user-image/m7.jpg"), postal_code: '9110817', prefecture: '福井県', city: '勝山市旭毛屋町', street: '1-1-1', email: 'syogo@syogo', password: '123456', age: '30代', gender: '男',)
# User.create(name: '斎藤　智也', nick_name: '智也', profile_image: open("#{Rails.root}/db/user-image/back9.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tomoya@tomoya', password: '123456', age: '20代', gender: '男',)
# User.create(name: '山田　加奈子', nick_name: 'kanako', profile_image: open("#{Rails.root}/db/user-image/back10.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kanako@knk', password: '123456', age: '20代', gender: '女',)
# User.create(name: '宮本　香織', nick_name: 'かおり', profile_image: open("#{Rails.root}/db/user-image/back11.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kaori@kor', password: '123456', age: '20代', gender: '女',)
# User.create(name: '香川　俊樹', nick_name: 'toshiki', profile_image: open("#{Rails.root}/db/user-image/back12.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'tosiki@tsk', password: '123456', age: '20代', gender: '男',)
# User.create(name: '松本　仁志', nick_name: 'まっちゃん', profile_image: open("#{Rails.root}/db/user-image/back13.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'hitosi@matumoto', password: '123456', age: '20代', gender: '男',)
# User.create(name: '浜田　正敏', nick_name: 'はまちゃん', profile_image: open("#{Rails.root}/db/user-image/back14.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'masatosi@hamada', password: '123456', age: '20代', gender: '男',)
# User.create(name: '浜家　和成', nick_name: 'kazu', profile_image: open("#{Rails.root}/db/user-image/back15.jpg"), postal_code: '8111124', prefecture: '福岡県', city: '福岡市早良区金武', street: '1-1-1', email: 'kazu@kazu', password: '123456', age: '30代', gender: '男',)
...
Post.create(user_id: '1', title: '小笠原でザトウクジラに遭遇！奇跡の出会い', body: '小笠原でザトウクジラに出会ってしまった……
...
Post.create(user_id: '1', title: '粟国島のダイビングは最強の大物天国！', body: '良いときもあれば悪いときもある。
...
Post.create(user_id: '1', title: '【水深40mに眠る沈船】エモンズでダイビング！', body: '水深40mに眠るアメリカの駆逐艦エモンズ。
...
Post.create(user_id: '1', title: '小笠原諸島のダイビングが超おすすめ！', body: '東洋のガラパゴスと呼ばれ、地球の歴史の中で1度も大陸と繋がったことのない小笠原諸島。
...
Post.create(user_id: '1', title: 'ラジャアンパットのダイビングの魅力を伝えたい', body: 'あなたはラジャアンパットの海でダイビングしたことがありますか？
...
Post.create(user_id: '1', title: 'プエルトガレラのダイビング！フィリピンの秘境', body: 'プエルトガレラのダイビングは日本では有名ではない。
...
Post.create(user_id: '2', title: '実は知らない伊江島のダイビングの魅力！', body: '伊江島といえば美ら海水族館の真正面に見えることで有名な島。
...
Post.create(user_id: '2', title: 'まるで異世界！？芸術的な白い砂地に魅了される', body: 'こんなに青く美しい砂浜を見たことあるでしょうか？
...
Post.create(user_id: '2', title: 'ダイナミックな地形の三宅島でダイビング！！', body: '三宅島のダイビングには独特の魅力があると言われている。
...
Post.create(user_id: '3', title: '小笠原諸島・父島周辺のダイビングポイント！', body: 'ダイバーなら誰もが1度は行ってみたいという小笠原諸島。
...
Post.create(user_id: '3', title: '本栖湖のダイビング”侘び寂び”を感じる新たな体験！', body: '「水中は音のない無重力の世界」
...
Post.create(user_id: '3', title: 'まだ神子元でダイビングしたことない人に届けたい！', body: '神子元のダイビングは超上級者向けなのか？
...
Post.create(user_id: '4', title: '魚影抜群！魚も心も踊る一生忘れられない経験に！', body: '冒頭では田子のダイビングを紹介する写真として外海のダイナミックな魚影の写真を使いましたが、実は田子には台風が直撃しない限りダイビングすることが可能な最強の湾内のポイントがあるんです。
...
Post.create(user_id: '4', title: '与論島のダイビングの本当の魅力！', body: '与論島のダイビングといえば、やっぱり「沈船あまみ」や「海中宮殿」が有名ですね！
...
Post.create(user_id: '5', title: 'ずっと憧れていたケータ列島は夢の世界だった', body: '夢だけど夢じゃなかった。
...
Post.create(user_id: '5', title: '与論島で静かに眠る「沈船あまみ」で潜るために！', body: 'ダイバーなら誰もが憧れたことのあるのがレックダイビング。
...
Post.create(user_id: '5', title: '世界遺産知床岬の絶景だけじゃなかった話', body: 'まるで人が立ち入ることを
拒むかのような厳しい自然の知床半島。
...
Post.create(user_id: '6', title: '「春のダイビングは面白くない」は本当か！？', body: '正直に言います。
...
Post.create(user_id: '7', title: '阿真ビーチはすべてが絶景だった', body: 'ウミガメと泳ぎたい。
...
Post.create(user_id: '7', title: '座間味ダイビング旅日記【2/2日目】', body: 'ここは、ますだ岩という砂地にポツンとある根にスカシテンジクダイやキンギョハナダイが群れた景色が非常にキレイで癒し系のポイントです。
...
Post.create(user_id: '7', title: '座間味ダイビング旅日記【1/2日目】', body: 'まずは那覇の泊港発のフェリーに乗って座間味へやってきました！
...
Post.create(user_id: '8', title: '小笠原に行ったら絶対ホエールウォッチングをすべき！', body: '小笠原諸島でホエールウォッチングは絶対にやったほうが良い。
...
Post.create(user_id: '8', title: '沖縄北部の秘密のビーチでダイビング！', body: '誰も知らないダイビングポイントに潜る。
こんなにワクワクすることはないでしょう。
...
Post.create(user_id: '8', title: 'ダイビングは冒険だ！ダイナミックな水中鍾乳洞に潜る', body: '沖縄本島の最北に位置する辺戸岬。
...
Post.create(user_id: '9', title: '大瀬崎のダイビングがアツい', body: '冬にダイビングに行くと言うと……
ビックリされることも多いでしょう。
